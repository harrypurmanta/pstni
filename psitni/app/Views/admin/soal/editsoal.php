                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= $jawaban[1]->jawaban_id ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= $jawaban[0]->materi ?>/group/<?= $jawaban[0]->group_id ?>/<?= $jawaban[0]->jawaban_img ?>" alt="" width="200" height="200">
                                            ...
                                            <div class="row col-sm-12">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= $jawaban[1]->jawaban_id ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= $jawaban[1]->materi ?>/group/<?= $jawaban[0]->group_id ?>/<?= $jawaban[1]->jawaban_img ?>" alt="" width="200" height="200">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[2]) ? $jawaban[2]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[2]->materi) ? $jawaban[2]->materi : '' ?>/group/<?= $jawaban[0]->group_id ?>/<?= isset($jawaban[2]->jawaban_img) ? $jawaban[2]->jawaban_img : '' ?>" alt="" width="200" height="200">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[3]->jawaban_id) ? $jawaban[3]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[3]->materi) ? $jawaban[3]->materi : '' ?>/group/<?= $jawaban[0]->group_id ?>/<?= isset($jawaban[3]->jawaban_img) ? $jawaban[3]->jawaban_img : '' ?>" alt="" width="200" height="200">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div id="dv_jwbimg_<?= isset($jawaban[4]->jawaban_id) ? $jawaban[4]->jawaban_id : '' ?>">
                                                                <img src="<?= base_url() ?>/images/jawaban/materi/<?= isset($jawaban[4]->materi) ? $jawaban[4]->materi : '' ?>/group/<?= $jawaban[0]->group_id ?>/<?= isset($jawaban[4]->jawaban_img) ? $jawaban[4]->jawaban_img : '' ?>" alt="" width="200" height="200">
