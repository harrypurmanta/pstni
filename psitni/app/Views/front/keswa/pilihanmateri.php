                    ...
                    <div class="row">
                        <div class="col-md-12" style="height: 400px;">
                            <div class="bg-gray col-md-8 text-center" style="top: 50%;left: 50%;transform: translate(-50%, -50%);height: 300px;">
                                ...
                                <?php
                                    echo "<p style='text-align:center;font-size:20px;margin:20px;'>Jawablah pertanyaan di bawah ini dengan memilih pilihan jawaban yang paling  tepat! Ya/Tidak. Pilih jawaban sesuai kepribadian asli agar hasil tes valid.</p>";
                                ?>
                                <p style="text-align:center;font-size:20px;"><b><i>Mulai</i></b>, Maka akan langsung masuk ke Pengerjaan soal Selamat Mengerjakan</p>
                                <?php
                                    ...
                                    if ($group[0]->group_soal_id == 1) {
                                        ...
                                        $url = base_url("keswa/ujian/" . $materi_id . "/" . $group[0]->group_soal_id);
